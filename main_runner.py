...
if __name__ == "__main__":
    ...
    parser.add_argument("--Scam_Detect_model_path", default='./all_data_final_no_data_leakage_v2', help="Path for the Scam Detection model (relative to scam_detection.py inside of the Scam_Detect folder)")
